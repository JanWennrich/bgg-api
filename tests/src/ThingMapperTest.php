...
final class ThingMapperTest extends TestCase
{
    ...
    public function testGetDesigners(): void
    {
        ...
        $items = $this->thing->getLinks(); // @phpstan-ignore deadCode.unreachable
    ...
    public function testGetCategories(): void
    {
        ...
        $items = $this->thing->getBoardgameCategories(); // @phpstan-ignore deadCode.unreachable
        $this->assertCount(1, $items);
    ...
    public function testGetMechanics(): void
    {
        ...
        $items = $this->thing->getBoardgameMechanics(); // @phpstan-ignore deadCode.unreachable
    ...
    public function testGetExpansions(): void
    {
        ...
        $items = $this->thing->getBoardgameExpansions(); // @phpstan-ignore deadCode.unreachable
    ...
    public function testGetArtists(): void
    {
        ...
        $items = $this->thing->getBoardgameArtists(); // @phpstan-ignore deadCode.unreachable
        $this->assertCount(1, $items);
    ...
    public function testGetPublishers(): void
    {
        ...
        $items = $this->thing->getBoardgamePublishers(); // @phpstan-ignore deadCode.unreachable
